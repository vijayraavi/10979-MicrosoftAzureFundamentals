...
13.   In the **New MySQL Database** blade, type **10979d04_db1** in the **Database Name** text box.
...
16.   Ensure that **Mercury** appears under **Pricing Tier** and then click **OK**.
17.   Click **Legal Terms (ClearDB)**.
18.   On the **Create** blade, click **Create**.
19.   Ensure that **Application Insights** setting is set to **Off**.
...
21.   After it is created, the WordPress web app blade will open automatically in the Azure portal interface.
