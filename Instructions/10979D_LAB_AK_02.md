...
5.   On MIA-CL1, start Microsoft Edge and browse to **https://aka.ms/devicelogin**. 
6.   On the **Device Login** page, type the code included in the message displayed in step 4.
7.   Once you type in the code, you will be presnted with another page identifying the Microsoft Azure CLI as the application that you are attempting to sign it to. Click **Continue**. You will be automatically redirected to the **Microsoft Azure** sign-in page.
