...
2.   From the Azure portal, create another virtual machine by choosing the  **Windows Server 2012 R2 Datacenter** image in the Azure Marketplace and by using the **Resource Manager** deployment model with the following settings:
  -   Name:  **labvnetvm2**
