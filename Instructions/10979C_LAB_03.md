...
2.   From the  **Settings** blade of labvm1, attach two new disks with the following settings:
  ...
  -   Storage Container:  Click **Browse** and select the Storage Account that includes **disks** in the name, then click the **vhds**    container and click on the **Select** button
  
  -   Storage Blob Name: Accept the default
